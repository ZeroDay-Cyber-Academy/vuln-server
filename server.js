...
app.get('/user', async (req, res) => {
 ...
 //   correction // const query = `SELECT name, role FROM users WHERE name = $1`; // vulnérable SQLi
 // autre vulnerabilité, toute les columns ressortent dont le password qui est aussi stocké en clair
